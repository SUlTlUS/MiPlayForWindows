...
$package = Join-Path $artifacts 'DLNACast.Windows_0.2.4.0_x64.msix'
...
# project. A manually assembled MSIX still needs the root resources.pri and XBF
# payloads so ms-appx:///MainWindow.xaml can resolve under package identity.
